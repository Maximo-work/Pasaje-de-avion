...
from vuelo_general import HistorialVu
...
print(vuelo_madrid.llamar_siguiente_pasajero()) # Sale Elena (Prio 4)
print(vuelo_madrid.llamar_siguiente_pasajero()) # No hay más pasajeros